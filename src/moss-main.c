...
static const clap_plugin_descriptor_t s_my_plug_desc = {
   ...
   .id = "de.mossgrabers.MossClap",
   .name = "moss-clap",
   .vendor = "MOSS",
   .url = "https://mossgrabers.de/moss-clap",
   .manual_url = "https://mossgrabers.de/moss-clap",
   .support_url = "https://mossgrabers.de/moss-clap/support",
   .version = "0.0.1",
   .description = "What a cool first plugin!",
   .features = (const char *[]){
